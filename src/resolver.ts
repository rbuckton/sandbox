...
export class Resolver {
    ...
    constructor(base: string, paths?: Paths) {
        ...
        this.module = new NodeJSModule(origin);
    ...
    private resolveTemplatePaths(fragment: string, templatePaths: ReadonlyArray<string>, parent: NodeJSModule) {
    ...
    private resolvePaths(paths: ReadonlyArray<string>, parent: NodeJSModule) {
